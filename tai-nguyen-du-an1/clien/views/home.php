            ...
            <div class="row row-20 mtn-20">
                <div class="col-sm-6">
                    <figure class="banner-statistics mt-20">
                        <a href="#">
                            <img src="assets/img/logo/logo2.png" alt="product banner">
                        </a>
        ...
        <div class="container">
            <div class="row">
                <div class="col-12">
                    <!-- section title start -->
                    <div class="section-title text-center">
                        <h2 class="title">Các sản phẩm được mua nhiều nhât</h2>
                        <p class="sub-title">Sản phẩm mới giá tốt phù hợp với mọi lứu tuổi"</p>
                    </div>
                    <!-- section title start -->
                </div>
            </div>
